const quizData = [
    ...
    {
        question: "who is your team leader?",
        options: ["Dhanush jadhav", "Deepak.G", "Mohan.B", "Likith"],
        answer: "Dhanush jadhav",
    },
    {
  ...
  function retryQuiz() {
    ...
    showAnswerButton.style.display = "inline-block"; // Keep it visible for retry
